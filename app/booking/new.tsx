/**
 * New Booking Screen - Single Page Form
 *
 * Creates a new booking with trip details, cost breakdown by category,
...
import { createBooking } from '../../src/services/bookings/bookingService'
...
export default function NewBookingScreen() {
  ...
  const [exchangeRate, setExchangeRate] = useState('0.0385') // Default JPY to MYR
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Success',
        `Booking ${createdBooking.bookingNumber} created successfully.`,
      ...
      <YStack flex={1} backgroundColor={theme.bgPrimary}>
        ...
        >
          ...
          <Pressable
            onPress={handleSave}
            disabled={isSaving}
            style={[styles.createBtn, { backgroundColor: theme.gold, opacity: isSaving ? 0.7 : 1 }]}
          >
